...
return_type lrw_aes_encrypt( const uint8_t in[N_BLOCK],
                         uint8_t out[N_BLOCK],
...
void lrw_aes_encrypt_128( const uint8_t in[N_BLOCK],
                      uint8_t out[N_BLOCK],
...
void lrw_aes_encrypt_256( const uint8_t in[N_BLOCK],
                      uint8_t out[N_BLOCK],
